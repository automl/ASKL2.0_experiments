...
def collect_data_for_final_table(model_list, res_dc, valid_pretty, horizon_list,
                                 ...
                                 print_per_seed_results=False, n_seeds=10):
    ...
    for horizon in horizon_list:
        ...
        for mode in model_list[horizon]:
            ...
            for tid in task_ids_sorted_by_num_features:
                ...
                assert tmp.shape == (n_seeds,), tmp.shape
...
def do_wilcoxon_test(stat_test_data, model_list, horizon_list, valid_pretty, alpha=0.05,
                     exclude=(), print_results=False):
    not_different = {}
    for h in horizon_list:
        ...
        for m in model_list[h]:
            ...
            if print_results:
                print(valid_pretty[h][best_m], valid_pretty[h][m], p, opt, chal)
